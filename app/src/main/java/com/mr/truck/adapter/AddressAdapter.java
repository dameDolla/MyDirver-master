...
public class AddressAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (selectPosition == i) {
            ...
            holder.province.setTextColor(context.getResources().getColor(R.color.titleColorSelected));
        } else {
            holder.main.setBackgroundColor(context.getResources().getColor(R.color.white));
            holder.province.setTextColor(context.getResources().getColor(R.color.black));
        }
