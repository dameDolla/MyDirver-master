...
/**
 * Created by yanqi on 2017/10/26.
 */

public class SetSignByDialog extends Dialog {
    /**
     * 上下文对象 *
     */
    Activity context;
    ...
    public SetSignByDialog(Activity context) {
        super(context);
        this.context = context;
    }

    public SetSignByDialog(Activity context, int theme, View.OnClickListener clickListener) {
        super(context, theme);
        this.context = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 指定布局
        this.setContentView(R.layout.setsignby_dialog);
