...
import com.mr.truck.activities.CarInfoActivity;
import com.mr.truck.activities.CompanyInfoActivity;
import com.mr.truck.activities.FaPiaoSettingActivity;
import com.mr.truck.activities.LoginActivity;
import com.mr.truck.activities.MyCarTeamActivity;
import com.mr.truck.activities.MyCardListActivity;
import com.mr.truck.activities.MyMessageActivity;
...
import com.mr.truck.activities.SelectDriverActivity;
...
public class MineFragment extends Fragment implements View.OnClickListener {
    ...
    private void showItem() {
        rlList.get(4).setVisibility(View.GONE);
            ...
            case R.id.mine_rl_szmx:
                if (isLogin){
                    if (GetUserInfoUtils.isRenzheng(getContext())){
                        startActivity(new Intent(getContext(), SZMXActivity.class));
                    }else {
                        ToolsUtils.toRenzhengMain(getActivity());
                    }
                }else {
