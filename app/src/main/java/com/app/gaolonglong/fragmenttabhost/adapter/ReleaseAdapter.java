       ...
       // viewHolder.fabudate.setText(get);
        viewHolder.cancle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    textInterface.onclick(position, Constant.RELEASE_CANCLE,date.getTruckplansGUID());
                }
            }
        });
        viewHolder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(textInterface != null)
                {
                    textInterface.onclick(position,Constant.RELEASE_EDIT,date.getTruckplansGUID());
                }
            }
        });
        viewHolder.del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(textInterface != null)
                {
                    textInterface.onclick(position,Constant.RELEASE_DEL,date.getTruckplansGUID());
                }
            }
        });
    }
