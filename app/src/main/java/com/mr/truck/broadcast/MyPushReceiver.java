package com.mr.truck.broadcast;
    ...
    private void processCustomMessage(Context context, Bundle bundle) {
        ...
        if (extras != null) {
            try {
                ...
                String val = object.getString("sound");
                if (val.equals("invitedbj")) {
                    builder.setSound(Uri.parse("android.resource://" + context.getPackageName() + "/" + R.raw.invitebj));
                }else if (val.equals("replybj")){
                    builder.setSound(Uri.parse("android.resource://" + context.getPackageName() + "/" +R.raw.replaybj));
                }else if (val.equals("agreebj")){
                    builder.setSound(Uri.parse("android.resource://" + context.getPackageName() + "/" +R.raw.agreebj));
                }else if (val.equals("missiondone")){
                    builder.setSound(Uri.parse("android.resource://" + context.getPackageName() + "/" +R.raw.missiondone));
                }
        ...
        //notification.sound = Uri.parse("android.resource://" + context.getPackageName() + "/" +R.raw.weixinyy);
        ...
        /*
         ...
         msgIntent.putExtra(context.KEY_EXTRAS, extras);
         }
         } catch (JSONException e) {
